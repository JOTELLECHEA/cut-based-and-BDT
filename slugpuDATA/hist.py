...
ttZ17 = g.Get('ttZ17')
#---------------------------Functions------------------------------------------#
def HH0(x):return int(ttHH0.GetBinContent(x)*990/(930000/0.609))
def H0(x):return int(ttH0.GetBinContent(x)*(612000/610000.))
def Z0(x):return int(ttZ0.GetBinContent(x)*(269000/270000.))
def bb0(x):return int(ttbb0.GetBinContent(x)*(5850000/5900000.))
#---------------------------table/values --------------------------------------#
